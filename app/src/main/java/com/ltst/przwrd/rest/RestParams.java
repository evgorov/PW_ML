...
public class RestParams
{
    ...
    public static final @Nonnull String URL_POST_BUY_PUZZLE_SET = URL_API + "/sets/%s/buy" + addParam(SESSION_KEY, true) + addParam(RECEIPT_DATA, false) + addParam(SIGNATURE, false);
