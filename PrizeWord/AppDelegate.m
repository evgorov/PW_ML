...
{
    return [DataContext currentContext].persistentStoreCoordinator.managedObjectModel;
}
...
{
    return [DataContext currentContext].persistentStoreCoordinator;
}
